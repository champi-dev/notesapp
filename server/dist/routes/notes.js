...
import { getNotes, getNote, createNote, updateNote, trashNote, restoreNote, deleteNote, bulkTrash, emptyTrash, } from '../controllers/noteController.js';
import { authenticate } from '../middleware/auth.js';
import { validate } from '../middleware/validate.js';
import { createNoteSchema, updateNoteSchema, getNotesQuerySchema, bulkTrashSchema, } from '../validators/noteValidators.js';
const router = Router();
